...
#include "j1939_data.h"
...
#if defined(MCHP_C18)
    #define RXB0CON_RX0DBEN     RXB0CONbits.RX0DBEN
    ...
    #define COMSTAT_RX0OVFL     COMSTATbits.RX0OVFL
    #define PIR3_RXB1IF         PIR3bits.RXB1IF
    #define COMSTAT_RX1OVFL     COMSTATbits.RX1OVFL
 ...
 ********************************************************************/
                    ...
                    enum CAN_CONFIG_FLAGS config)
 {
    ...
    CANSetMask(CAN_MASK_B1, tp_ID, CAN_CONFIG_XTD_MSG);
    CANSetMask(CAN_MASK_B2, tp_ID, CAN_CONFIG_XTD_MSG);
    ...
    CANSetFilter(CAN_FILTER_B1_F1, tp_ID, FilterConfig1);
    CANSetFilter(CAN_FILTER_B1_F2, tp_ID, FilterConfig1);
    CANSetFilter(CAN_FILTER_B2_F1, tp_ID, FilterConfig2);
    CANSetFilter(CAN_FILTER_B2_F2, tp_ID, FilterConfig2);
    CANSetFilter(CAN_FILTER_B2_F3, tp_ID, FilterConfig2);
    CANSetFilter(CAN_FILTER_B2_F4, tp_ID, FilterConfig2);
                        ...
                        enum CAN_CONFIG_FLAGS type)
{
    ...
    else
    {
        ...
        ptr++;                                  // Point to SIDL
        Value->BYTES.BYTE_3 |= (*ptr & 0x03);   // Copy SIDL<1:0> to EID<17:16>
